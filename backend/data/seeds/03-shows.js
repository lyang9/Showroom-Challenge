  ...
  return knex('shows').del()
    .then(function () {
      ...
      return knex('shows').insert([
        ...
        {title: 'Spider-Man: Into the Spider-Verse', img_url: 'https://img00.deviantart.net/08d6/i/2019/046/9/6/spiderman_into_the_spiderverse_v2_by_edgina36-dcztwdn.png', user_id: 2, genre_id: 2},
